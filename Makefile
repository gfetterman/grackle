...
test : test.o fundamentals.o environment.o parse.o evaluate.o end_to_end_tests.o unit_tests_fundamentals.o unit_tests_environment.o unit_tests_parse.o test_utils.o
	$(CC) $(CC_OPTS) $^ -o $@
